...
const LootDeal = () => {
  ...
  useEffect(() => {
    axios.get("http://localhost:3000/lootDeal") 
      .then((res) => setData(res.data))
      .catch((err) => console.error("Failed to fetch loot deals:", err));
  }, []);
