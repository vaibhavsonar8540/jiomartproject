...
const Cricket = () => {
  ...
  useEffect(() => {
    axios.get(" http://localhost:3000/cricket") 
      .then((res) => setData(res.data))
      .catch((err) => console.error("Failed to fetch cricket detail:", err));
  }, []);
